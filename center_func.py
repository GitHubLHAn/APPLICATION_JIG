...
def Center_process(_uart_var, firm_path_goc, log_path_goc, infor_mach):
    # Lưu log dữ liệu test của mạch ------------------------------------------ 
    folder_path = log_path_goc+ "\Center"
    ...
    C19 = "-"   # RS485
    C20 = "-"   # Detect Chute Sensor
    C21 = "-"   # RF module
    C22 = "-"   # Speaker
    C23 = "-"   # Load main program
    
    # Gửi lệnh reset mạch JIG-----------------------------------------------------
    buffer_cmd = [0xAB, 0xCD, 0x00, 0x02, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0x20]
    ...
    buffer_cmd = [0xAB, 0xCD, 0x10, 0x02, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0x30]
    _uart_var.send_data(buffer_cmd)
            ...
            if (data_res[0] == 0xEA) & (data_res[11] == CS_byte):
                ...
                # Impedance
                    ...
                    if data_res[2] == TEST_OK:
                        ...
                        Array_print = "-> ERROR: Lỗi test trở kháng mạch CENTER lộ 8v0 !!!\n"
                        In_loi(Array_print)
                        C12 = "ERROR"   # Impedance path 8v0 
                        vErrorCode = "ERROR_TroKhang_8v0_Center"
                        vKetthuc = True
                    elif data_res[2] == TEST_ERROR_2:
                        Array_print = "-> ERROR: Lỗi test trở kháng mạch CENTER lộ 5vBus !!!\n"
                        In_loi(Array_print)
                        C12 = "PASS"   # Impedance path 8v0 
                        C13 = "ERROR"   # Impedance path 5vBus
                        vErrorCode = "ERROR_TroKhang_5vBus_Center"
                        vKetthuc = True
                    elif data_res[2] == TEST_ERROR_3:
                        Array_print = "-> ERROR: Lỗi test trở kháng mạch CENTER lộ 5v0 !!!\n"
                        In_loi(Array_print)
                        C12 = "PASS"   # Impedance path 8v0 
                        C13 = "PASS"   # Impedance path 5vBus
                        C14 = "ERROR"   # Impedance path 5v0
                        vErrorCode = "ERROR_TroKhang_5v0_Center"
                        vKetthuc = True
                    elif data_res[2] == TEST_ERROR_4:
                        Array_print = "-> ERROR: Lỗi test trở kháng mạch CENTER lộ 3v3 !!!\n"
                        In_loi(Array_print)
                        C12 = "PASS"   # Impedance path 8v0 
                        C13 = "PASS"   # Impedance path 5vBus
                        C14 = "PASS"   # Impedance path 5v0
                        C15 = "ERROR"   # Impedance path 3v3
                        vErrorCode = "ERROR_TroKhang_3v3_Center"
                        vKetthuc = True   
                # Voltage
                    ...
                    if data_res[2] == TEST_OK:
                        ...
                        Array_print = "-> ERROR: Lỗi test điện áp mạch CENTER lộ 5v0 !!!\n"
                        In_loi(Array_print)
                        C16 = "ERROR"   # Voltage path 5v0
                        vErrorCode = "ERROR_DienAp_5v0_Center"
                        vKetthuc = True
                    elif data_res[2] == TEST_ERROR_2:
                        Array_print = "-> ERROR: Lỗi test điện áp mạch CENTER lộ 3v3 !!!\n"
                        In_loi(Array_print)
                        C16 = "PASS"   # Voltage path 5v0
                        C17 = "ERROR"   # Voltage path 3v3
                        vErrorCode = "ERROR_DienAp_3v3_Center"
                        vKetthuc = True             
                # St_link
                    ...
                    if data_res[2] == TEST_OK:
                        ...
                        time.sleep(0.5)
                        # Nap code test
                        firm_path_center_test = firm_path_goc + "\center_board\center_test.hex"
                        ...
                        if kq_fw == 1:
                            ...
                            time.sleep(2)
                            buffer_cmd = [0xAB, 0xCD, 0x50, 0x02, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0x70]
                            _uart_var.send_data(buffer_cmd)                            
                        else:
                            Array_print = "-> ERROR: Nạp firmware test thất bại !!!\n"
                            In_loi(Array_print)
                            C18 = "ERROR"   # Load test program
                            vErrorCode = "ERROR_NapCode_Center"
                            vKetthuc = True
                    else:
                        Array_print = "-> ERROR: Lỗi kết nối St-Link !!!\n"
                        In_loi(Array_print)
                        vErrorCode = "ERROR_STLink_Center"
                        vKetthuc = True                
                # Code test
                    ...
                    if data_res[2] == TEST_OK:
                        ...
                        if kq == 1:
                            ...
                            buffer_cmd = [0xAB, 0xCD, 0x00, 0x02, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0x20]
                            _uart_var.send_data(buffer_cmd)
                            vErrorCode = "ERROR_NapCodeTest_Center"
                            vKetthuc = True              
                ...
                # Function
                    ...
                    if data_res[2] == TEST_OK:
                        C19 = "PASS"   # RS485
                        C20 = "PASS"   # Detect Chute Sensor
                        C21 = "PASS"   # RF module   
                        # Speaker
                        print(Fore.MAGENTA+"         Bạn có nghe còi kêu không?           \n"+ Style.RESET_ALL)
                        print("      1.Có                    2. Không\n")
                        listen = int(input("> Nhập vào kết quả lắng nghe: "))
                        if listen == 1:
                            Array_print = "-> Test Funtion thành công, bắt đầu nạp code chính !\n"
                            In_ketqua(Array_print)
                            C22 = "PASS"   # Speaker
                            # Nạp code chính
                            firm_path_center_test = firm_path_goc + "\center_board\center_main.hex"
                            kq_fw = flash_firmware(firm_path_center_test)
                            if kq_fw == 1:
                                ...
                                time.sleep(5)
                                buffer_cmd = [0xAB, 0xCD, 0x70, 0x02, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0x90]
                                _uart_var.send_data(buffer_cmd)  
                            else:
                                Array_print = "-> ERROR: Nạp firmware chính thất bại !!!\n"
                                In_loi(Array_print)
                                C23 = "ERROR"   # Load main program
                                vErrorCode = "ERROR_NapCode_Center"
                                vKetthuc = True
                        else:
                            Array_print = "-> ERROR: Lỗi CENTER Còi không kêu !!!\n"
                            In_loi(Array_print)
                            C22 = "ERROR"   # Speaker
                            # Gửi lệnh reset Jig
                            time.sleep(0.5)
                            buffer_cmd = [0xAB, 0xCD, 0x00, 0x02, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0x20]
                            _uart_var.send_data(buffer_cmd)
                            vErrorCode = "ERROR_CoiBao_Center"
                            vKetthuc = True                       
                    elif data_res[2] == TEST_ERROR_1:
                        Array_print = "-> ERROR: Lỗi Mạch CENTER RS485 !!!\n"
                        In_loi(Array_print)
                        C19 = "ERROR"   # RS485
                        vErrorCode = "ERROR_RS485_Center"
                        vKetthuc = True
                    elif data_res[2] == TEST_ERROR_2:
                        Array_print = "-> ERROR: Lỗi Mạch CENTER Nút nhấn !!!\n"
                        In_loi(Array_print)
                        vErrorCode = "ERROR_NutNhan_Center"
                        vKetthuc = True
                    elif data_res[2] == TEST_ERROR_3:
                        Array_print = "-> ERROR: Lỗi Mạch CENTER Cảm biến máng !!!\n"
                        In_loi(Array_print)
                        C19 = "PASS"   # RS485
                        C20 = "ERROR"   # Detect Chute Sensor
                        vErrorCode = "ERROR_CamBien_Center"
                        vKetthuc = True
                    elif data_res[2] == TEST_ERROR_4:
                        Array_print = "-> ERROR: Lỗi Mạch CENTER RF Module !!!\n"
                        In_loi(Array_print)
                        C19 = "PASS"   # RS485
                        C20 = "PASS"   # Detect Chute Sensor
                        C21 = "ERROR"   # RF module 
                        vErrorCode = "ERROR_RF_Module_Center"
                        vKetthuc = True
                    elif data_res[2] == TEST_ERROR_5:
                        Array_print = "-> ERROR: Lỗi Mạch CENTER Driver Motor !!!\n"
                        In_loi(Array_print)
                        vErrorCode = "ERROR_DriverMotor_Center"
                        vKetthuc = True              
                    elif data_res[2] == TEST_ERROR_6:
                        Array_print = "-> ERROR: Lỗi Mạch CENTER Không bật được Còi !!!\n"
                        In_loi(Array_print)
                        C19 = "PASS"   # RS485
                        C20 = "PASS"   # Detect Chute Sensor
                        C21 = "PASS"   # RF module   
                ...
                # Code chính
                    ...
                    if data_res[2] == TEST_OK:
                        ...
                        In_ketqua(Array_print)
                        C23 = "PASS"   # Load main program
                        vErrorCode = "TEST_CENTER_OK"
                        vKetthuc = True
                    elif data_res[2] == TEST_ERROR:
                        ...
                        if kq == 1:
                            ...
                            buffer_cmd = [0xAB, 0xCD, 0x00, 0x02, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0x20]
                            _uart_var.send_data(buffer_cmd)
                            vErrorCode = "ERROR_NapCodeChinh_Center"
                            vKetthuc = True
                else:
                    print(data_res)
                    print("Nothing\n")
    ...
    ws["B19"] =  "RS485"
    ws["B20"] =  "Detect Chute Sensor"
    ws["B21"] =  "RF module"
    ws["B22"] =  "Speaker"
    ws["B23"] =  "Load main program"
